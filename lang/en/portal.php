...
return [
    ...
    'appointments' => [
        ...
        'change' => 'Change',
        'cancel' => 'Cancel',
        'cancel_confirm' => 'Cancel this appointment? The slot will be given up.',
        'cancelled' => 'Booking :reference is cancelled.',
        'moved' => 'Booking :reference has been moved. The desk will confirm the new time.',
        'reschedule_title' => 'Move your appointment',
        'reschedule_lede' => 'Pick another time with :doctor. Your booking reference stays the same, and the desk will confirm it again.',
        'reschedule_current' => 'Booked now',
        'reschedule_pick_date' => 'Choose a day',
        'reschedule_pick_time' => 'Choose a time',
        'reschedule_no_slots' => 'Nothing free on that day.',
        'reschedule_submit' => 'Move the appointment',
        'reschedule_loading' => 'Checking what is free…',
        'reschedule_back' => 'Leave it as it is',
        'reschedule_note' => 'Moving it puts the booking back to unconfirmed until the desk agrees the new time.',
        'change_note_off' => 'To change or cancel an appointment, call :phone and quote the reference.',
        'change_note_on' => 'You can move or cancel an upcoming appointment here. For anything else, call :phone and quote the reference.',
    ],
