...
return [
    ...
    'patient_moved' => [
        'subject' => 'আপনার অ্যাপয়েন্টমেন্ট :reference সরানো হয়েছে',
        'preheader' => 'এটি এখন :date তারিখে :time সময়ে।',
        'heading' => 'আপনার অ্যাপয়েন্টমেন্টের সময় বদলেছে',
        'intro' => ':doctor-এর সঙ্গে আপনার অ্যাপয়েন্টমেন্ট এখন :date তারিখে :time সময়ে। রেফারেন্সসহ বাকি সব কিছু আগের মতোই আছে।',
        'was' => 'আগে এটি ছিল :previous।',
        'body' => 'নতুন সময়টি আপনার জন্য অসুবিধাজনক হলে :number নম্বরে কল করুন, আমরা অন্য একটি সময় ঠিক করে দেব।',
    ],
];
