...
@section('content')
    ...
    <div class="admin-card overflow-hidden"
         x-data="adminList({ list: 'packages', sortable: true,
                ...
                <table class="w-full min-w-[46rem]">
                    ...
                    <tbody>
                        @foreach ($packages as $package)
                            <tr class="admin-row" data-id="{{ $package->id }}"
                                ...
                                <td class="admin-td">
                                    <div class="flex items-center gap-2">
                                        <x-admin.live-switch :model="$package" />
                                        <x-admin.translation-state :model="$package" compact />
                                    </div>
                                </td>
