...
<div {{ $attributes->merge(['class' => 'sticky bottom-0 -mx-5 mt-6 flex flex-wrap items-center gap-3 border-t border-mist-200 bg-white/95 px-5 py-4 backdrop-blur sm:-mx-8 sm:px-8 lg:-mx-10 lg:px-10']) }}>
